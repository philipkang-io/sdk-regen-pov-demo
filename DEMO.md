> **Note:** `README.md` at the repo root is generated by Postman and is
> overwritten on every SDK regeneration. This file is the demo's own
> documentation and is safe to edit.
...
| `src/`, `documentation/`, `examples/` | The generated SDK **at the repo root** — this is where Postman's auto-PR writes, so it has to live here for regeneration to merge against it |
